...
function SignInPatient() {
    ...
    const sendCredentials = async (e) => {
      ...
      try {
        axios
          .post("https://urgencias-servidor-project.vercel.app/Patient/signInPatient", {
            identificacion,
            password,
          })
          .then((res) => {
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form className="space-y-6" onSubmit={sendCredentials}>
              {!error ? (
                ...
                <div className="text-center bg-red-500 text-white font-semibold text-lg py-3 rounded-xl">
                  {error}
                </div>
              )}
              <div>
